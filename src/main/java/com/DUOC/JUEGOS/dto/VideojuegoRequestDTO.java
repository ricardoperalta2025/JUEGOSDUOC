...
public class VideojuegoRequestDTO {
    ...
    //  Strings van con NotBlank
    // Numericos van con NotNull
    // deben armarse de acuerdo a los atributos con que se definen en el modelo
    // es decir, si es Long, se pone Long, si es Integer, se pone Integer, BigDecimal se pone BigDecimal, etc                           
    ...
    // En los 3 casos de objetos, solo calleamos id
    // como se definen con Long, se usa ese tipo de valor
